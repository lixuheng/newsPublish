							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="title"
										name="news.title" placeholder="标题">
								</div>
							</div>
						</div>
						<div class="col-md-5">
					...
					<div class="row">
						<div class="col-md-5">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="hidden"
										name="news.user.user_id" value="${session.user.user_id}">
									<input type="text" class="form-control" id="author"
										name="news.user.uname" value="${session.user.uname}" readonly="readonly">
								</div>
							</div>
						</div>
						<div class="col-md-5">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="addr"
										name="news.place" placeholder="发生地点">
								</div>
							</div>
						</div>
						<div class="col-md-5">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="text3"
										name="news.source" placeholder="新闻来源">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-md-10">
							<div id="editor-container" class="container">
								...
								<!-- <input type="hidden" name="news.content" id="hid" >  -->
							</div>
